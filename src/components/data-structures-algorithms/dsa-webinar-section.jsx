...
const webinarPoints = [
  ...
  "System design finally starts making sense, not just buzzwords thrown at you",
  "What interviewers actually expect, not what random prep videos tell you",
  "A simple way to approach any system design question without freezing",
  "Where most engineers go wrong and how to avoid those mistakes early",
  "A clear path on what to learn, what to skip, and how to improve faster",
  
]

export function DsaWebinarSection() {
