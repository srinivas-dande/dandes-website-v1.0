...
export function AimlCTASection() {
  ...
  const courseSection = document.getElementById("ai-courses")
    if (courseSection) {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
           Ready to start? Get your syllabus and next batch details
          </h2>

          <p className="text-gray-600 mb-8">
            Share your goal, and we'll send you the Applied AI Engineering syllabus, fee details, and next batch schedule on WhatsApp, email, or a quick call. If you're unsure whether this track or our 12-month AI & Machine Learning program is the better fit, our team will guide you based on your background and target role.
          </p>
