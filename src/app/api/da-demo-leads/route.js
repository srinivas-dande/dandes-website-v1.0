...
export async function POST(req) {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;background:#f5f7fa;padding:30px;">
        <div style="max-width:520px;margin:auto;background:#fff;border-radius:8px;padding:25px;box-shadow:0 2px 8px rgba(0,0,0,.05);">
          <h2 style="color:#C41E3A;">New AI & Machine Learning Demo Lead</h2>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            ...
            <tr><td style="padding:8px;font-weight:bold;">Course Interested</td><td style="padding:8px;">${courseInterested || "-"}</td></tr>
            <tr><td style="padding:8px;font-weight:bold;">Lead Source</td><td style="padding:8px;">${leadSource || "-"}</td></tr>
            <tr><td style="padding:8px;font-weight:bold;">Lead Sub Source</td><td style="padding:8px;">${leadSubSource || "-"}</td></tr>
            <tr><td style="padding:8px;font-weight:bold;">Page URL</td><td style="padding:8px;">${pageUrl || "-"}</td></tr>
            <tr><td style="padding:8px;font-weight:bold;">IP Address</td><td style="padding:8px;">${ipAddress}</td></tr>
            <tr><td style="padding:8px;font-weight:bold;">Lead Status</td><td style="padding:8px;">${lead.lead_status}</td></tr>
            <tr>
  ...
  fetch(
    "https://connect.pabbly.com/webhook-listener/webhook/IjU3NjIwNTY0MDYzMTA0MzA1MjZkNTUzZCI_3D_pc/IjU3NjcwNTY5MDYzMTA0MzU1MjY5NTUzMzUxM2Ii_pc",
    {
      method: "POST",
      headers: {
